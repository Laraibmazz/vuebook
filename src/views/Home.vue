<template>
  <div class="home">
    <html lang="en">
      ...
      <body>
        <div
          class="jumbotron-fluid bg-light row justify-content-center align-items-center"
        >
          <nav
            class="navbar navbar-expand-lg navbar-light bg-light row justify-content-between align-items-center"
          ...
          >
            <div class="row align-items-center">
              <div>
                <button
                  type="button"
                  class="btn btn-light material-icons text-dark"
                >
                  menu
                </button>
              </div>
              <div class="ml-3">
                <svg
                  ...
                  style="pointer-events: none; display: block; width: 80px"
                >
                  <g
                    viewBox=" 0 0 200 60"
                    preserveAspectRatio="xMidYMid meet"
              ...
              <ul class="nav justify-content-center align-items-center">
                ...
                <li class="nav-item">
                  <div class="dropdown">
                    ...
                    >
                      <img
                        src="https://i.ytimg.com/an_webp/xJZOHtH_bvo/mqdefault_6s.webp?du=3000&sqp=CIbP__wF&rs=AOn4CLAP7CY_ORClxR-pOWdpw6DLtYqs4g"
                        alt=""
                    ...
                    >
                      ...
                      <a class="dropdown-item text-muted" href="#"
                        >Another action</a
                      >
                      <a class="dropdown-item text-muted" href="#">#</a>
                    </div>
                  </div>
                </li>
              </ul>
        ...
        <main>
          <div class="container-fluid pl-" style="width: 100%">
            <div class="d-flex">
              <div class="" style="width: 230px">
                ...
                >
                  ...
                  <hr class="m-0" />
                  <div class="card pt-0 rounded-0 border-0">
                    <h6 class="mt-3 ml-2">Subscriptions</h6>
                    <div
                      class="card-body p-2 pt-3 pb-3 m-0"
                      style="width: 230px"
                      v-for="(a, index) in subs"
                      @click="click"
                      :key="index"
                    >
                      <div class="d-flex align-items-center">
                  ...
                  <hr class="m-0" />
                  <h6 class="mt-3 ml-2">More From vuebook</h6>
                  <div
                    class="card p-0 rounded-0 border-0"
                    v-for="(item, index) in categories"
                    :key="index"
                  >
                    <div class="card-body p-2 pt-3 pb-3" style="width: 230px">
                      <div class="d-flex align-items-center">
                        <span
                          class="material-icons text-dark"
                          style="
                  ...
                  >
                    <div class="">
                      <img
                        ...
                        src="https://i.ytimg.com/an_webp/GPnsayCnZmc/mqdefault_6s.webp?du=3000&sqp=CNCHkP0F&rs=AOn4CLAWPivA0xT1EnsSPniZkKeri6lQyQ"
                        alt=""
                      />
                      <div class="mt-2">
                        <div class="d-flex">
                          <div>
                            <img
                              src="https://yt3.ggpht.com/a-/AOh14Gh6CZENxxRynJexEIRdk-MQmRvy-oSx7eFksQ=s68-c-k-c0x00ffffff-no-rj-mo"
                              class="rounded-circle"
                              width="36"
                              alt=""
                            />
                          ...
                          <div class="">
                            <h6 class="m-0 p-0" style="font-size: 14px">
                              Top 10 stupid people caught on camrea | Haider Tv
                            </h6>
                            <div>
                              <small class="m-0 p-0" style="font-size: 13px">
                                Haider Tv
                              </small>
  ...
  data() {
    return {
      subs: [
        {
          src:
            "https://i.ytimg.com/an_webp/kkFFq11j6dQ/mqdefault_6s_480x270.webp?du=3000&sqp=CODAiv0F&rs=AOn4CLCoQu5NbmLXbwmBg7hbgAT3ESRxrA",
          name: "The Bee Family",
        },
        {
          src:
...
window.onload = () => {
  document.getElementById('scr').innerHTML = window.innerWidth
}
window.onresize = () => {
  document.getElementById('scr').innerHTML = window.innerWidth
}
